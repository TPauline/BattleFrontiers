...
//			rectangle.setFill(Color.GREENYELLOW);
	...
	public void handleRedMouseExited() {
		...
		hRed.setStyle("-fx-border-color: rgba(0, 100, 100); -fx-border-radius: 10; -fx-border-width:2.5;");
	...
	public void handleBlueMouseExited() {
		...
		hBlue.setStyle("-fx-border-color: rgba(0, 100, 100); -fx-border-radius: 10; -fx-border-width:2.5;");
	...
	public void handleGreenMouseExited() {
		...
		hGreen.setStyle("-fx-border-color: rgba(0, 100, 100); -fx-border-radius: 10; -fx-border-width:2.5;");
