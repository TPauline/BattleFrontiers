...
public class LeaderBoardSceneController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		windowRoot.getStylesheets().add("leaderBoardScene.css");
		windowRoot.setCenter(l1);

	}

	public void handleExitButtonClick() {
		System.out.println("LeaderBoard Exit Button Clicked");
		System.exit(0);
	}

	public void handleContinueButtonClick() throws Exception {
		System.out.println("LeaderBoard Start Button Clicked");
		try {
	...
	public void handleHomeButtonClick() {
		System.out.println("LeaderBoard  BackButton Clicked");
