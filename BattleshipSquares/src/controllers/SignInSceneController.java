...
public class SignInSceneController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		windowRoot.getStylesheets().add("signInScene.css");
	...
	public void handleExitButtonClick() {
		System.out.println("SignIN Exit Button Clicked");
		System.exit(0);
	}
	
	public void handleContinueButtonClick() throws Exception {
		System.out.println("SignIN Start Button Clicked");
		try {
	...
	public void handleHomeButtonClick() {
		System.out.println("SignIN  HomeButton Clicked");
